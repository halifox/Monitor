...
import 'package:monitor/src/widgets/control_tiles.dart';
import 'package:monitor/src/widgets/soft_group.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Consumer(
                    builder: (context, ref, child) {
                      final asyncData = ref.watch(
                        monitorEdidProvider(logicalHandle),
                      );
                      return SoftGroup(
                        ...
                        children: <Widget>[
                          ...
                          StaticTextListTile(
                            l10n.manufactured,
                            asyncData,
                            (value) => value.manufactured,
                          ),
                          StaticTextListTile(
                            l10n.edidVersion,
                            asyncData,
                            (value) => value.edidVersion,
                          ),
                          StaticTextListTile(
                            l10n.inputType,
                            asyncData,
                          ...
                          StaticTextListTile(
                            l10n.preferredTiming,
                            asyncData,
                            (value) => value.preferredTiming,
                          ),
                          StaticTextListTile(
                            l10n.extensionBlocks,
                            asyncData,
                            (value) => value.extensionBlocks.toString(),
                          ),
                          StaticTextListTile(
                            l10n.rawData,
                            asyncData,
                            (value) {
                              String clean = value.rawData.replaceAll(
                                RegExp(r'\s+'),
                                '',
                              );
                  ...
                  SoftGroup(
                    ...
                    children: <Widget>[
                      StaticTextListTile(
                        l10n.capabilitiesString,
                        capabilitiesAsync,
                        (value) => value.rawString,
                        style: GoogleFonts.robotoMono(fontSize: 10),
                      ),
                      StaticTextListTile(
                        l10n.controlCodesSupported,
                        capabilitiesAsync,
                        (value) => "",
                      ),
                      StaticTextListTile(
                      ...
                      StaticTextListTile(
                        l10n.mccsCompliance,
                        capabilitiesAsync,
                        (value) => value.mccsVersion,
                      ),
                      StaticTextListTile(
                        l10n.commandLineEditor,
                        capabilitiesAsync,
                        (value) => "",
                      ),
                    ],
                  ...
                  SoftGroup(
                    ...
                    children: <Widget>[
                      TextListTile(
                        handle,
                        0xAC,
                        l10n.horizontalFrequency,
                        (value) => "${value.currentValue} Hz",
                      ),
                      TextListTile(
                        handle,
                        0xAE,
                        l10n.verticalFrequency,
                        (value) =>
                            "${(value.currentValue / 100.0).toStringAsFixed(2)} Hz",
                      ),
                      TextListTile(
                        handle,
                        0xC0,
                        l10n.displayUsageTime,
                        (value) => "${value.currentValue} ${l10n.hours}",
                      ),
                      TextListTile(handle, 0xC8, l10n.displayControllerType, (
                        value,
                      ) {
                        ...
                        return switch (v) {
                          ...
                          _ =>
                            "${l10n.unknown} (0x${v.toRadixString(16).toUpperCase()})",
                        };
                      }),
                      TextListTile(handle, 0xC9, l10n.displayFirmwareLevel, (
                        value,
                      ) {
                      ...
                      ComboBoxListTile(
                        handle,
                        0xCA,
                        l10n.osdButtonControl,
                        {
                          0x01: l10n.osdDisabled,
                          0x02: l10n.osdEnabled,
                          0xFF: l10n.cannotSupplyInfo,
                        },
                        enabledValues: capabilitiesInfo?.vcpValues[0xCA],
                      ),
                      ComboBoxListTile(
                        handle,
                        0xCC,
                  ...
                  SoftGroup(
                    ...
                    children: <Widget>[
                      ActionListTile(
                        handle,
                        0x04,
                        l10n.restoreFactoryDefaults,
                        {0x01: l10n.restore},
                      ),
                      ActionListTile(
                        handle,
                        0x05,
                        l10n.restoreFactoryLuminanceContrast,
                        {0x01: l10n.restore},
                      ),
                      ActionListTile(
                        handle,
                        0x06,
                        l10n.restoreFactoryGeometry,
                        {0x01: l10n.restore},
                      ),
                      ActionListTile(handle, 0x08, l10n.restoreFactoryColor, {
                        0x01: l10n.restore,
                      }),
                      ActionListTile(handle, 0x0A, l10n.restoreFactoryTV, {
                        0x01: l10n.restore,
                      }),
                      ActionListTile(handle, 0xB0, l10n.settings, {
                        0x01: l10n.storeCurrentSettings,
                        0x02: l10n.restoreFactoryDefaults,
                      }),
                    ],
                  ),
                  const SizedBox(height: 8),
                  SoftGroup(
                    ...
                    children: <Widget>[
                      ...
                      SiderListTile(
                        handle,
                        0x26,
                        l10n.horizontalPincushionBalance,
                      ),
                      ...
                      SiderListTile(
                        handle,
                        0x2C,
                        l10n.horizontalLinearityBalance,
                      ),
                      ...
                      SiderListTile(
                        handle,
                        0x36,
                        l10n.verticalPincushionBalance,
                      ),
                      ...
                      ComboBoxListTile(
                        handle,
                        0x82,
                        l10n.horizontalMirror,
                        {
                          0x00: l10n.normalMode,
                          0x01: l10n.mirroredHorizontally,
                        },
                        enabledValues: capabilitiesInfo?.vcpValues[0x82],
                      ),
                      ComboBoxListTile(
                        handle,
                        0x84,
                        l10n.verticalMirror,
                        {0x00: l10n.normalMode, 0x01: l10n.mirroredVertically},
                        enabledValues: capabilitiesInfo?.vcpValues[0x84],
                      ),
                      ComboBoxListTile(
                        handle,
                        0x86,
                      ...
                      ComboBoxListTile(
                        handle,
                        0x99,
                        l10n.windowControlOnOff,
                        {0x00: l10n.noEffect, 0x01: l10n.off, 0x02: l10n.on},
                        enabledValues: capabilitiesInfo?.vcpValues[0x99],
                      ),
                      TextListTile(
                        handle,
                        0xA4,
                        l10n.windowControlValue,
                        (value) =>
                            "SL: ${value.currentValue & 0xFF}, SH: ${(value.currentValue >> 8) & 0xFF}",
                      ),
                      ComboBoxListTile(
                        handle,
                        0xDA,
                        l10n.scanMode,
                        {
                          0x00: l10n.normalOperation,
                          0x01: l10n.underscan,
                          0x02: l10n.overscan,
                          0x03: l10n.widescreen,
                        },
                        enabledValues: capabilitiesInfo?.vcpValues[0xDA],
                      ),
                    ],
                  ),
                  const SizedBox(height: 8),
                  SoftGroup(
                    ...
                    children: <Widget>[
                      TextListTile(
                        handle,
                        0x0B,
                        l10n.colorTemperatureIncrement,
                        (value) => "${value.currentValue} K",
                      ),
                      TextListTile(
                        handle,
                        0x0C,
                        l10n.colorTemperatureRequest,
                        (value) => "${value.currentValue * 100 + 3000} K",
                      ),
                      TextListTile(
                        handle,
                        0x0E,
                      ...
                      ActionListTile(handle, 0x1E, l10n.autoSetup, {
                        0x00: l10n.disabled,
                        0x01: l10n.enabled,
                        0x02: l10n.periodic,
                      }),
                      ActionListTile(handle, 0x1F, l10n.autoColorSetup, {
                        0x00: l10n.disabled,
                        0x01: l10n.enabled,
                        0x02: l10n.periodic,
                      }),
                      ...
                      TextListTile(
                        handle,
                        0x74,
                        l10n.singlePointLutOperation,
                        (value) => "${value.currentValue}",
                      ),
                      TextListTile(
                        handle,
                        0x75,
                        l10n.blockLutOperation,
                        (value) => "${value.currentValue}",
                      ),
                      SiderListTile(handle, 0x7C, l10n.adjustZoom),
                      SiderListTile(
                        handle,
                        0x7D,
                        l10n.whiteLedBacklightControl,
                      ),
                      SiderListTile(handle, 0x7E, l10n.redLedBacklightControl),
                      SiderListTile(
                        handle,
                        0x7F,
                        l10n.greenLedBacklightControl,
                      ),
                      ...
                      ActionListTile(handle, 0xA2, l10n.autoSetupOnOff, {
                        0x01: l10n.off,
                        0x02: l10n.on,
                      }),
                      ComboBoxListTile(
                      ...
                      TextListTile(handle, 0xAA, l10n.screenOrientation, (
                        value,
                      ) {
                        return switch (value.currentValue) {
                          ...
                          _ =>
                            "${l10n.unknown} (0x${value.currentValue.toRadixString(16).toUpperCase()})",
                        };
                      }),
                  ...
                  SoftGroup(
                    ...
                    children: <Widget>[
                      ...
                      ActionListTile(handle, 0x8D, l10n.audioMute, {
                        0x01: l10n.mute,
                        0x02: l10n.unmute,
                      }),
                  ...
                  SoftGroup(
                    ...
                    children: <Widget>[
                      ...
                      ComboBoxListTile(
                        ...
                        0xBE,
                        l10n.linkControl,
                        {0x01: l10n.disabled, 0x02: l10n.enabled},
                        enabledValues: capabilitiesInfo?.vcpValues[0xBE],
                      ),
                    ],
                  ),
                  const SizedBox(height: 8),
                  SoftGroup(
                    ...
                    children: <Widget>[
                      ActionListTile(handle, 0x01, l10n.degauss, {
                        0x01: l10n.activate,
                      }),
                      ActionListTile(handle, 0x02, l10n.newControlValue, {
                        0x01: l10n.reset,
                      }),
                      ActionListTile(handle, 0x03, l10n.softControls, {
                        0x01: l10n.reset,
                      }),
                      TextListTile(
                        handle,
                        ...
                        l10n.activeControl,
                        (value) =>
                            "VCP code 0x${value.currentValue.toRadixString(16).toUpperCase()}",
                      ),
                      NumericListTile(
                        handle,
                        0x54,
                        l10n.performancePreservation,
                      ),
                      ComboBoxListTile(
                        handle,
                        0x60,
                      ...
                      ComboBoxListTile(
                        handle,
                        0x66,
                        l10n.ambientLightSensor,
                        {0x01: l10n.disabled, 0x02: l10n.enabled},
                        enabledValues: capabilitiesInfo?.vcpValues[0x66],
                      ),
                      TextListTile(
                        handle,
                        0x76,
                        l10n.remoteProcedureCall,
                        (value) => "${value.currentValue}",
                      ),
                      ActionListTile(
                        handle,
                        0x78,
                        l10n.displayIdentificationOperation,
                        {0x01: l10n.readEdidBlock},
                      ),
                      ActionListTile(handle, 0x8B, l10n.tvChannelUpDown, {
                        0x01: l10n.increment,
                        0x02: l10n.decrement,
                      }),
                      TextListTile(handle, 0xB2, l10n.flatPanelSubPixelLayout, (
                        value,
                      ) {
                        return switch (value.currentValue) {
                      ...
                      TextListTile(handle, 0xB6, l10n.displayTechnologyType, (
                        value,
                      ) {
                        return switch (value.currentValue) {
                      ...
                      TextListTile(
                        handle,
                        0xC2,
                        l10n.displayDescriptorLength,
                        (value) => "${value.currentValue}",
                      ),
                      TextListTile(
                        handle,
                        0xC3,
                        l10n.displayDescriptorToTransmit,
                        (value) => "${value.currentValue}",
                      ),
                      ComboBoxListTile(
                        handle,
                        0xC4,
                        l10n.enableDisplayOfDescriptor,
                        {0x01: l10n.disabled, 0x02: l10n.enabled},
                        enabledValues: capabilitiesInfo?.vcpValues[0xC4],
                      ),
                      TextListTile(
                        handle,
                        0xC6,
                        l10n.applicationEnableKey,
                        (value) =>
                            "0x${value.currentValue.toRadixString(16).toUpperCase()}",
                      ),
                      NumericListTile(handle, 0xCD, l10n.statusIndicators),
                      TextListTile(
                        handle,
                        0xCE,
                        l10n.auxiliaryDisplaySize,
                        (value) => "${value.currentValue}",
                      ),
                      TextListTile(
                        handle,
                        0xCF,
                        l10n.auxiliaryDisplayData,
                        (value) => "${value.currentValue}",
                      ),
                      ComboBoxListTile(
                        handle,
